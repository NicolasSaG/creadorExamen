                ...
                <div className="col">
                  <div className="form-group">
                    ...
                    <p>
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.drags.option[0].img}`}
                      ></img>
                    </p>
                    <p>
                      drag option 2:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.drags.option[1].img}`}
                      ></img>
                    </p>
                    <p>
                      drag option 3:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.drags.option[2].img}`}
                      ></img>
                    </p>
                    <p>
                      drag option 4:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.drags.option[3].img}`}
                      ></img>
                    </p>
                  </div>
                </div>
                <div className="col">
                  <div className="form-group">
                    ...
                    <p>
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.targets.option[0].img}`}
                      ></img>
                    </p>
                    <p>
                      target option 2:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.targets.option[1].img}`}
                      ></img>
                    </p>
                    <p>
                      target option 3:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.targets.option[2].img}`}
                      ></img>
                    </p>
                    <p>
                      target option 4:
                      ...
                      <img
                        src={`http://localhost:8080/images/${this.state.selectedQuestion.targets.option[3].img}`}
                      ></img>
                    </p>
                  </div>
                </div>
