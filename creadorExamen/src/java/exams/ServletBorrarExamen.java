 ...
 * @author
 */
public class ServletBorrarExamen extends HttpServlet {
   @Override
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      response.addHeader("Access-Control-Allow-Origin", "*");
      response.setContentType("text/html");
      response.getWriter().println("Servlet Para Borrar Examenes");
   }
   ...
   protected void doPost(HttpServletRequest request, HttpServletResponse response)
      ...
      String interactionId = request.getParameter("idExam");
      ...
      try {
          ...
          * 
          * for(int i = 0; i!=contenido.size();i++){ Element basura = contenido.get(i);
